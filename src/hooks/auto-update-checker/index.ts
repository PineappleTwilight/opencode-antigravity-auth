import type { AutoUpdateCheckerOptions } from "./types.ts"
import { getCachedVersion, getLocalDevVersion, findPluginEntry, getLatestVersion, updatePinnedVersion } from "./checker.ts"
import { invalidatePackage } from "./cache.ts"
import { PACKAGE_NAME } from "./constants.ts"
import { logAutoUpdate } from "./logging.ts"
...
export type { UpdateCheckResult, AutoUpdateCheckerOptions } from "./types.ts"
export { checkForUpdate, getCachedVersion, getLatestVersion } from "./checker.ts"
export { invalidatePackage, invalidateCache } from "./cache.ts"
